function Clickheretoprint(url,iframeId){ 
  ...
  var content_vlue = myIFrame.contentWindow.document.body.innerHTML;
	  var docprint=window.open("","",disp_setting); 
	   ...
	   docprint.document.write('<div style="clear:both;"><div style="font-size:18px; clear:both; padding:0px 0 5px 0; text-align:left;  font-weight:bold; width:700px; float:left;"></div>');
	   docprint.document.write('<div style="float:right; position:relative;"><input type="button" title="Print this page" value="Print this page" onclick="self.print();"/></div></div>');
...
var content_vlue = myIFrame.contentWindow.document.body.innerHTML;
	  var docprint=window.open("","",disp_setting); 
	   ...
	   docprint.document.write ('<div style="width:900px; margin:0px auto; font-family:arial; text-align:justify; font-size:12px; padding:10px; background:#fff; color:#000;">');        
	   docprint.document.write('<div style="clear:both; text-align:left; float:left; background-color:#000; margin-bottom:30px;"> <img src="'+url+'/images/deceBrand_logo.png"/> </div>');
	   docprint.document.write("<div style='clear:both;'><div style='font-size:18px; clear:both; float:left; padding:0px 0 5px 0; text-align:left;  font-weight:bold; width:700px'></div>");
...
var content_vlue = myIFrame.contentWindow.document.body.innerHTML;
	  var docprint=window.open("","",disp_setting); 
	   docprint.document.open(); 
	   docprint.document.write("<html><h:head><title>UltraViolet Junior Privacy Policy - Print</title>"); 
	   docprint.document.write('</h:head><body><center>'); 
	   docprint.document.write ('<div style="width:900px; margin:0px auto; font-family:arial; text-align:justify; font-size:12px; padding:10px; background:#fff; color:#000;">');        
	   docprint.document.write('<div style="clear:both; text-align:left; float:left; background-color:#000; margin-bottom:30px;"> <img src="'+url+'/images/deceBrand_logo.png"/> </div>');
	   docprint.document.write("<div style='clear:both;'><div style='font-size:18px; clear:both; float:left; padding:0px 0 5px 0; text-align:left;  font-weight:bold; width:700px'></div>");
