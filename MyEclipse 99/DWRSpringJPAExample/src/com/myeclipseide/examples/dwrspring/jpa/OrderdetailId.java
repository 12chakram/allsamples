...
/**
 * OrderdetailId generated by MyEclipse Persistence Tools
 */
@Embeddable
public class OrderdetailId implements java.io.Serializable {
	...
	@Column(name = "PURCHASEORDERNUMBER", unique = false, nullable = false, insertable = true, updatable = true)
	...
	@Column(name = "PRODUCTCODE", unique = false, nullable = false, insertable = true, updatable = true, length = 15)
