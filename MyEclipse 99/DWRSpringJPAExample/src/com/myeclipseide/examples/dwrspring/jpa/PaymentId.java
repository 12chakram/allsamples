...
/**
 * PaymentId generated by MyEclipse Persistence Tools
 */
@Embeddable
public class PaymentId implements java.io.Serializable {
	...
	@Column(name = "CUSTOMERNUMBER", unique = false, nullable = false, insertable = true, updatable = true)
	...
	@Column(name = "CHECKNUMBER", unique = false, nullable = false, insertable = true, updatable = true, length = 50)
