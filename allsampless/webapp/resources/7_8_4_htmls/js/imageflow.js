...
var conf_slider_width = 25;          // Sets the px width of the slider div
	...
	for (var index = 0; index < max; index++)
	{
		...
		else 
		{
			...
			{ 
				...
				image.style.width = 170 + 'px';  // changed by joshi
...
function refresh(onload)
{
	...
	images_width = 550;  /* changed by joshi*/ 
	...
	imageflow_div.style.height = (max_height-20) + 'px'; //modified by sireesh
	...
	scrollbar_div.style.marginTop = 50 + 'px'; // changed by joshi
	//scrollbar_div.style.marginLeft = images_width * 0.2 + 'px';
	scrollbar_div.style.marginLeft = 200 + 'px'; // changed by joshi
...
function init()
{
	if(document.getElementById(conf_imageflow))
	{
		...
		initMouseWheel();
		initMouseDrag();
		glideTo(-500, 0); //modified by sirees: to set slider center position
	}
}
