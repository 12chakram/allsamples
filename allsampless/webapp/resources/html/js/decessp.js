...
function Clickheretoprintcoppa(){ 
  ...
  var content_vlue = myIFrame.contentWindow.document.body.innerHTML;
	  var docprint=window.open("","",disp_setting); 
	   docprint.document.open(); 
	   docprint.document.write('<html><head><title>UltraViolet - Data-collection Policy - Print</title>'); 
	   docprint.document.write('</head><body><center>'); 
	   docprint.document.write ('<div style="width:900px; margin:0px auto; font-family:arial; text-align:justify; font-size:12px; padding:10px; background:#fff; color:#000;">');        
	   docprint.document.write('<div style="clear:both; text-align:left; float:left; background-color:#000;"> <img src="/images/deceBrand_logo.png"/> </div>');
	   docprint.document.write('<div style="font-size:18px; clear:both; padding:30px 0 5px 0; text-align:left;  font-weight:bold; width:400px">Data-collection Policy </div>');
	   docprint.document.write('<div style="float:right; position:absolute; left:900px; top:69px;"><input type="button" value="Print this page" onclick="self.print();"/></div>');
	   docprint.document.write('<div>');
	   docprint.document.write(content_vlue);        
	   docprint.document.write('</div></div></center></body></html>'); 
